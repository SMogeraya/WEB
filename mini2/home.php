...
<h1 style="font-family:DM Serif Display;font-size:35px;    margin-bottom: -6px;"> Registration form</h1>

<label for="mail"> MAIL ID... </label>
<!--<div class="ip"><img style="height:35px;width:35px"src="https://icon-library.com/images/email-icon-white-png/email-icon-white-png-25.jpg">--><input type="text" name="mail" size="20" id="mail" maxlength="20">

<label for="pass">PASSWORD...</label>
<input type="password" name="pass" size="10" id="pass" maxlength="20">

<label for="usname">FULL NAME...</label>
